...
module.exports = {
  getCollections: async (req, res, next) => {
    ...
    return Response.success(
      res,
      Message.SUCCESS_GET_COLLECTIONS,
      data,
      StatusCode.OK
    );
  },
  ...
  getCollection: async (req, res, next) => {
    ...
    const data =
      await collectionService.getCollectionByCollectionID(collectionID);
    if (!data || data.length === 0) {
      return Response.error(
        res,
        Message.ERROR_COLLECTION_NOT_FOUND,
        null,
    ...
    return Response.success(
      res,
      Message.SUCCESS_GET_COLLECTION,
      data,
      StatusCode.OK
    );
  },
  ...
  createCollection: async (req, res, next) => {
    ...
    if (existCollection.length !== 0) {
      return Response.error(
        res,
        Message.ERROR_COLLECTION_NAME_EXISTS,
        null,
        StatusCode.CONFLICT
      );
    }
    ...
    return Response.success(
      res,
      Message.SUCCESS_CREATE_COLLECTION,
      null,
      StatusCode.CREATED
    );
  },
  ...
  updateCollection: async (req, res, next) => {
    ...
    return Response.success(
      res,
      Message.SUCCESS_UPDATE_COLLECTION,
      null,
      StatusCode.OK
    );
  },
  ...
  deleteCollection: async (req, res, next) => {
    ...
    return Response.success(
      res,
      Message.SUCCESS_DELETE_COLLECTION,
      null,
      StatusCode.OK
    );
  }
